...
<img width="632" alt="image" src="https://github.com/user-attachments/assets/238b7247-d3a5-4ce6-855b-5faa50847731" />
...
### 2. 경력 정보 입력
- 사업명, 시작연월(YYYY-MM), 종료연월(YYYY-MM), 담당업무, 발주처, 기술스택, 근무형태를 입력합니다
